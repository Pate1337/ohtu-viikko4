...
public class VerkkokauppaTesti {
    ...
    @Test
    public void pankinMetodiaTilisiirtoKutsutaanOikeillaParametreillaKunTuotteitaKaksiErilaista() {
        Pankki pankki = mock(Pankki.class);
    ...
    @Test
    public void pankinMetodiaTilisiirtoKutsutaanOikeillaParametreillaKunTuotteitaKaksiSamanlaista() {
        Pankki pankki = mock(Pankki.class);
    ...
    @Test
    public void pankinMetodiaTilisiirtoKutsutaanOikeillaParametreillaKunTuotteitaKaksiErilaistaJaToinenLoppu() {
        Pankki pankki = mock(Pankki.class);
    ...
    @Test
    public void metodintilimaksuKutsuminenPyytääUudenViitenumeron() {
        Pankki pankki = mock(Pankki.class);
    ...
    @Test
    public void metodinPoistaKoristaKutsuminenPalauttaaTuotteenVarastoon() {
        Pankki pankki = mock(Pankki.class);
        ...
        k.lisaaKoriin(1);
        k.poistaKorista(1);
//        verify(varasto, times(1)).haeTuote(eq(1));
